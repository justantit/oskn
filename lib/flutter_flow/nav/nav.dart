...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const Step6Widget() : const LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'Step2',
          path: '/step2',
          builder: (context, params) => const Step2Widget(),
        ),
        FFRoute(
          name: 'Step3',
          path: '/step3',
        ...
        FFRoute(
          ...
          builder: (context, params) => Step4Widget(
            name: params.getParam('name', ParamType.String),
            goalSkin: params.getParam('goalSkin', ParamType.int),
            email: params.getParam('email', ParamType.String),
            password: params.getParam('password', ParamType.String),
          ),
        ),
        FFRoute(
          ...
          builder: (context, params) => Step5Widget(
            ...
            password: params.getParam('password', ParamType.String),
            goalSkin: params.getParam('goalSkin', ParamType.int),
            notice: params.getParam('notice', ParamType.int),
          ),
        ),
        FFRoute(
          name: 'Step6',
